...
\begin{document}
	...
	\subsubsection{NDSI's Motion Optical Flow}
	...
	We have used optical flow as a tool to generate \textbf{distance vectors} based on motion between the NDSI image in time \(t\) and NDSI image in time \(t + dt\). These vectors will be used in order to create the \textbf{motion predicted NDSI}.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.5]{../images/motion_generated_image.png}
		\caption{Motion generated NDSI.}
		\label{fig:motion_generated_image}
	\end{figure}
