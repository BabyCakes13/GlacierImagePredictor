...
\begin{document}
	...
	\par As a conclusion, we were able to investigate motion tendencies across time and use them to predict a future snapshot. On top of this, we have also successfully created a tool for easy asset search and acquisition from the Landsat archives.
